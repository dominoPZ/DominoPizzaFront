...
var addGoods = function(goodsCode) {
   ...
   var returnUrl = "/Pizza/Menu/sidedish_beverage.pz";
            ...
            <div class="tab_content_wrap">
               <div class="tab_content active">
                  <div class="visual_category">
                     <img
                        src="https://cdn.dominos.co.kr/renewal2016/ko/w/img/img_C0202.png"
                        alt="">
                  </div>
                           ...
                           <li class="${pclass}">
                              <div class="prd_img">
                                 ...
                                 <div class="prd_img_view">
                                    <img src="<c:url value='/Pizza/Image/sidedish/beverage/'/>${fn:replace(bvrg.d_img,' ', '')}"
               ...
               <div class="lst_guide" style="${footDisplay}">
                  <ul>
                     <li>※ 트윈크레페/올댓치즈 피자 상품권 이용 안내 <span>- 트윈크레페/올댓치즈 피자
                           단종으로 인해 해당 피자 상품권 구매 고객 대상으로 콜라 1.25L 무료제공하고 있습니다.<br>(주문금액
                           32,900원 초과 시 미제공)
                     </span>
                     </li>
                     <li>※ 도이치휠레 단종으로 인한 상품권 사용 안내 <span>- 타제품 주문 가능</span> (프리미엄
                        피자의 경우, 금액 추가)<br> <span>- 동일 가격 제품 :
                           포테이토/슈퍼슈프림/슈퍼디럭스/베이컨체더치즈 더블치즈 엣지, 리얼바비큐 곡물도우 </span>
                     </li>
      ...
      <div class="footer_wrap">
         <div class="company_info">
            <dl class="order_phone">
               <dt>전화주문</dt>
               <dd>
                  <span class="ico ico_phone"></span>1577-3082
               </dd>
            </dl>
            <ul class="list_sns">
               <li><a href="https://www.facebook.com/dominostory/"
                  target="_blank" class="btn_facebook">facebook</a></li>
               <li><a href="https://twitter.com/dominostory" target="_blank"
                  class="btn_twitter">twitter</a></li>
               <li><a href="http://blog.naver.com/dominostory"
                  target="_blank" class="btn_blog">blog</a></li>
               <li><a href="https://www.instagram.com/dominostory/"
                  target="_blank" class="btn_instar">instargram</a></li>
            </ul>
            <div class="footer_menu">
               <ul class="list_terms">
                  <li><a href="/company/contents/overview">회사소개</a></li>
                  <li><a href="/contents/privacy"><strong>개인정보
                           처리방침</strong></a></li>
               ...
               <address>Copyrightsⓒ2017 by Domino’s Pizza. All rights
                  reserved.</address>
         ...
         <div class="awards_area">
            <ul class="list_awards">
               <li><img
                  src="https://cdn.dominos.co.kr/renewal2016/ko/w/images/list_awards.png"
                  alt="">
                  <p>
                     식품안전<br>경영시스템 인증
                  </p></li>
               <li><img
                  src="https://cdn.dominos.co.kr/renewal2016/ko/w/images/list_awards2.png"
                  alt="">
                  <p>
                     지식경제부<br>우수디자인 선정
                  </p></li>
               <li><img
                  src="https://cdn.dominos.co.kr/renewal2016/ko/w/images/list_awards3.png"
                  alt="">
                  <p>
                     고객이 가장 추천하는 기업<br />피자전문점 부문 4년 연속 1위
                  </p></li>
               <li><img
                  src="https://cdn.dominos.co.kr/renewal2016/ko/w/images/list_awards4.png"
                  alt="">
                  <p>
                     2016년 「대한민국인터넷소통대상」<br />「대한민국소셜미디어대상」<br />Leading Star (7년 연속
                     종합 1위)
                  </p></li>
               <li><img
                  src="https://cdn.dominos.co.kr/renewal2016/ko/w/images/list_awards5.png"
                  alt="">
                  <p>
                     2016 한국산업의 고객만족도<br />피자전문점 부문 2년 연속 1위
                  </p></li>
            </ul>
         </div>
      </div>
